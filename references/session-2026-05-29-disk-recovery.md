...
**Root cause**: <backup-repo>/backups/current (17G) filled the disk.
...
- <backup-repo>: 5.1G (data/ has chroma.sqlite3 253M, backups duplicate data/)
- ~/backups/sessions.tar.gz: 2.6G (15K session JSONs already in state.db)
- /var/lib/docker: 1.8G
