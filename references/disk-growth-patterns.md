...
Manually created backups in `~/backup/YYYYMMDD_HHMMSS/` follow the same pattern: state.db dominates. On June 24 the backup was 9.4 GB (9.0 GB state.db + 253 MB chroma.sqlite3 + smaller DBs).
